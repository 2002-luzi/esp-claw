export const en = {
  ...
  sectionTts: 'Text-to-speech provider settings',
  ...
  ttsProviderNote:
    'Lua scripts use these device settings by default. Additional providers will appear here after their firmware provider is implemented.',

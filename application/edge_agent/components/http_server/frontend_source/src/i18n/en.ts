export const en = {
  ...
  sectionTts: 'Provider settings for the optional Lua TTS module',
  sectionTtsProvider: 'Provider',
  ttsProvider: 'TTS Provider',
  ttsProviderXiaoMimo: 'Xiao MiMo',
  ttsApiKey: 'API Key',
  ttsApiKeyPlaceholder: 'Leave blank to keep the saved key',
  ttsApiKeySavedHint: 'A key is saved. Enter a new value only when replacing it.',
  ttsApiKeyEmptyHint: 'No key is saved yet.',
  ttsApiKeyClear: 'Clear saved key',
  ttsModel: 'Model',
